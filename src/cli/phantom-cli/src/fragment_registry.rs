...
mod tests {
    ...
    fn test_cleanup_old() {
        ...
        // Add old stopped fragment
        let old_info = FragmentInfo {
            name: "old-fragment".to_string(),
            profile: "sandbox".to_string(),
            pid: None,
            created_at: now - 7200, // 2 hours ago
            status: FragmentStatus::Stopped,
            components: vec![],
            memory_kb: 4096,
            cpu_count: None,
            mode: "sandbox".to_string(),
        ...
        registry.register(old_info).unwrap();

        // Add recent running fragment
        let recent_info = FragmentInfo {
            name: "recent-fragment".to_string(),
            profile: "sandbox".to_string(),
            pid: Some(12345),
