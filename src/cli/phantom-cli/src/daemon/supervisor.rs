...
pub struct DaemonSupervisor {
    ...
    pub(crate) restart_attempts: Arc<AtomicU32>,
    /// Current backoff duration in milliseconds
    pub(crate) current_backoff_ms: Arc<AtomicU64>,
    /// Statistics
    pub(crate) stats: Arc<SupervisorStatsWrapper>,
...
pub(crate) struct SupervisorStatsWrapper {
...
impl DaemonSupervisor {
    ...
    pub(crate) fn handle_daemon_crash(&mut self) {
